...
def start_playing():
    ...
    add_log("Recognizing the chess board...")
    ...
    if found_chessboard:
        ...
        add_log("Unable to find the chess board")
...
label_titre = tk.Label(text="cheating is for trash ones if u don't learn from it ",anchor="e", wraplength = 300)#\nThis bot can not work on a game that already started")
